					<footer id="footer" class="site-footer card shadow-sm border-0">
						<?php
							do_action('argon_footer_html');
							echo get_option('argon_footer_html');
						?>
						<div>Powered By <a href="https://wordpress.org" target="_blank"><strong>WordPress</strong></a>. Theme <a href="https://github.com/solstice23/argon-theme" target="_blank"><strong>Argon</strong></a><?php if (get_option('argon_hide_footer_author') != 'true') {echo " By solstice23"; }?>.</div>
					</footer>
				</main>
			</div>
		</div>
